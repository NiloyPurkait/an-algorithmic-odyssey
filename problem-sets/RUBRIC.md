...
Use 100 points per problem set.
...
| Visual explanation | 20 | The submission includes a clear trace, animation, diagram, or plot that exposes state changes over time. |
...
Award up to 10 optional extension points for:

- comparing two algorithmic approaches on the same task
- adding a polished interactive widget
- proving a stronger claim
- finding and explaining a subtle counterexample
- improving the shared visual tracing toolkit
