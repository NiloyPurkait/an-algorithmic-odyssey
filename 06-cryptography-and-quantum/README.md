...
This module closes the course at the edge of what computation can protect and what it can break. Secrecy is built on problems that are easy one way and hard the other; one lesson shows how to prove a fact while revealing nothing about it, and the final lesson shows how a quantum algorithm undermines exactly the hardness that public-key cryptography depends on.

## Field

Classical cryptography, public-key cryptography, interactive and zero-knowledge proofs, number theory, and quantum computing.
