...
- Play Eve against BB84: intercept every photon and watch the sifted error rate climb to 25%, then intercept only a fraction and show information and disturbance rise together.
- Checkpoint: connect RSA's factoring assumption to Shor's period finding and explain what changes what is practical.

## Response Standard

A strong response is short but concrete:
