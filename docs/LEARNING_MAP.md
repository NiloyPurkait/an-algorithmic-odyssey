...
| 6. Cryptography & Quantum Frontiers | Rotor machines, modular arithmetic, interactive proofs, quantum periods | Reason about secrecy, hardness, proof, and quantum speedups | Connect RSA's factoring assumption to Shor's period-finding attack, and explain how repeated random challenges make a zero-knowledge proof sound |
...
- Module 6: apply number theory to secrecy, prove a fact while revealing nothing, then see where quantum computing breaks the hardness.
